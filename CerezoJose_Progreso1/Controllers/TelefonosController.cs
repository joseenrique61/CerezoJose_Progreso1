...
namespace CerezoJose_Progreso1.Controllers
{
    public class TelefonosController : Controller
    {
        ...
        public TelefonosController(CerezoJose_Progreso1Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Modelo,Anio,Precio")] Telefono telefono)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Modelo,Anio,Precio")] Telefono telefono)
        {
            if (id != telefono.Id)
            {
                return NotFound();
